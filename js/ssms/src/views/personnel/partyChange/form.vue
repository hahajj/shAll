  ...
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="resetForm" :visible.sync="dialog" :title="isAdd ? '新增' : '编辑'" width="600px">
    <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="调动时间" prop="changeDate">
        <el-date-picker v-model="form.changeDate" type="date" style="width: 180px;" placeholder="选择调动时间" format="yyyy - MM - dd " value-format="timestamp" @blur="handleConversionDate" @change="handleConversionDate"/>
      </el-form-item>
