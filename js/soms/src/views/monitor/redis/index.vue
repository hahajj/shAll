  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['ADMIN','REDIS_ALL','REDIS_EDIT','REDIS_DELETE'])" label="操作" width="130px" align="center">
        <template slot-scope="scope">
          <el-button v-permission="['ADMIN','REDIS_ALL','REDIS_DELETE']" slot="reference" type="danger" icon="el-icon-delete" size="mini" @click="open(scope.$index, scope.row)"/>
        </template>
      </el-table-column>
    </el-table>
    <!--分页组件-->
