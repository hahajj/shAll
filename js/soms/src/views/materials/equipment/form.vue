      ...
      <el-row :gutter="15">
        ...
        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
          <el-form-item label="申请时间" prop="createdDate">
            ...
            <!--style="width: 152.5px;"-->
            <!--placeholder="选择日期"/>-->
            <el-input v-model="form.createdDate" placeholder="系统填写" disabled/>
          </el-form-item>
        </el-col>
        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
...
<script>
import { add, edit, delFile, getEquipment, getEquipmentPart, contentPreview, getContentsById } from '@/api/equipment'
...
export default {
  ...
  methods: {
    ...
    handleEquipmentPartName(data) {
      if (!data.children) {
        ...
        if (!data.equipmentPartInventory) {
          ...
          this.form.equipmentPartInventoryAmount = this.equipmentPartInventory.amount
          this.form.miniumAmount = this.equipmentPartInventory.miniumAmount
        } else {
          this.equipmentPartInventory = ''
        }
    ...
    reloadForm() {
      ...
      getContentsById(this.equipmentPartPurchaseId).then(res => {
    ...
    changeUploadData() {
      ...
      formData.append('createdDate', new Date(this.form.createdDate))
      ...
      formData.append('requireDeptName', this.form.requireDeptName)
