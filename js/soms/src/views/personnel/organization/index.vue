<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <div style="display: inline-block;">
        <el-button
          ...
          type="warning"
          icon="el-icon-more"
          @click="changExpand">{{ expand ? '折叠' : '展开' }}
        </el-button>
    ...
    <el-table
      ...
      <el-table-column
        v-if="checkPermission(['ADMIN','ORGANIZATION_ALL','ORGANIZATION_EDIT','ORGANIZATION_DELETE'])"
        label="操作"
        width="150px"
        align="center">
        <template slot-scope="scope">
          <el-button
            v-permission="['ADMIN','ORGANIZATION_ALL','ORGANIZATION_EDIT']"
            size="mini"
            type="primary"
            icon="el-icon-edit"
