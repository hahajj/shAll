...
// import { del, get, add } from '@/api/circular'
...
export default {
  ...
  methods: {
    ...
    beforeInit() {
      ...
      this.params = { page: this.page, size: this.size, sort: sort,circularReceiveId: this.$store.state.user.user.partyDTO.organization.organizationId  }
